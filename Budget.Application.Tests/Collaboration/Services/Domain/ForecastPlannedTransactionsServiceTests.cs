...
public class ForecastPlannedTransactionsServiceTests
{
    ...
    private void PublishPlannedTransactionCreationRequestEvent(string type, double amount, DateTime repeatStart, int repeatPeriod = 0, int repeatCount = 0)
    {
    ...
    private void CheckForSingleTransactionPlanResults(string type, double amount, int repeatPeriod, int forecastDayCount)
    {
        ...
        foreach (var forecastProjection in forecastProjections)
        {
            ...
            Assert.Equal(thisDate.Date, forecastProjection.Date.Date);
        }
    }
    ...
    private void RunAutoGeneratedTest(string type, double amount, DateTime repeatStart, int repeatPeriod, int forecastDayCount)
    {
        PublishPlannedTransactionCreationRequestEvent(type, amount, repeatStart, repeatPeriod);
        var createForecastCalculationRequested = CreateForecastCalculationRequestedEvent(forecastDayCount);
